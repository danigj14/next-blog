  ...
  return (
    <div className="container px-8 mx-auto">
      <nav className="flex items-center justify-between py-4">
        <Link href="/">
          <div className="flex items-center text-xl lg:text-2xl gap-4">
        ...
        <div
          ...
          } left-0 md:static bg-gray-50 px-10 w-screen md:w-fit text-xl flex-col items-start gap-6 transition-all md:flex-row pb-8`}
        >
